...
excelOutput = "C:\\Users\\aolson\\Documents\\GitHub\\xlwtExamples\\"
...
#wb.save(excelOutput + 'coloursExample.xls')
...
#wb.save(excelOutput + 'xlwtExample.xls')
...
#w.save(excelOutput + 'num_formatsExample.xls')
...
#wb.save(excelOutput + 'borderExample.xls')
...
#w.save(excelOutput + 'datesExample.xls')
...
#w.save(excelOutput + 'formulasExample.xls')
...
#w.save(excelOutput + 'numbersExample.xls')
...
#w.save(excelOutput + 'panesExample.xls')
...
#w.save(excelOutput + 'row_stylesExample.xls')
